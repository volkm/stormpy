...
void define_expressions(py::module& m) {
    ...
    py::native_enum<storm::expressions::OperatorType>(m, "OperatorType", "enum.Enum", "Type of an operator (of any sort)")
        ...
        .value("NOT_EQUAL", storm::expressions::OperatorType::NotEqual)
        .value("LESS", storm::expressions::OperatorType::Less)
        .value("LESS_OR_EQUAL", storm::expressions::OperatorType::LessOrEqual)
        .value("GREATER", storm::expressions::OperatorType::Greater)
        .value("GREATER_OR_EQUAL", storm::expressions::OperatorType::GreaterOrEqual)
