...
void define_bisimulation(py::module& m) {
    ...
    m.def("_perform_exact_bisimulation", &storm::api::performBisimulationMinimization<storm::RationalNumber>, "Perform bisimulation on exact model", py::arg("model"), py::arg("formulas"), py::arg("bisimulation_type"));
